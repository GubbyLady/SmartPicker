...
from v1_0.core.constant import SER_PORT,SER_BAUDRATE,NO_SERIAL_TURN_OFF
...
class SerialCom:
    ...
    def __init__(self, send_queue,recv_queue):
        try:
            self.Init()
            self.ser = Ser.Serial(v1_0.core.constant.SER_PORT, v1_0.core.constant.SER_BAUDRATE)
    ...
    def Init(self):
        ...
        for com in com_list:
            if com["com_name"] == "serial":
                v1_0.core.constant.SER_PORT = com["port"]
                v1_0.core.constant.SER_BAUDRATE = com["baudrate"]
            break

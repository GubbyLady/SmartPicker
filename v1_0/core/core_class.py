...
from v1_0.core.constant import LOGGER_LEVEL
from v1_0.core.constant import ServerConfig,QUEUE_SIZE, SER_SEND_QUEUE,SER_RECV_QUEUE
from v1_0.core.tools import Redis_server, Logger
from multiprocessing import Process,Queue
from v1_0.core.communication_class import SerialCom
from v1_0.core.message_class import Message
from v1_0.core.servers_class import CvServer,PickerServer
"""
该py文件运行流程
    启动日志
    先启动动态配置
...
class CoreClass:
    ...
    def core_Init(self):
        ...
        v1_0.core.constant.CORE_LOG = Logger(name="CORE",level=LOGGER_LEVEL)
        log_handle = v1_0.core.constant.CORE_LOG()

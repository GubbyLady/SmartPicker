...
from v1_0.servers.cv_server.constant import CvConstant, MY_CAMERA, HAIKANG, DAHENG, USB_CAMERA, CLASSES_LIST, MODEL_PATH,TEST_IMG_LIST, TEST_MP4_PATH
from v1_0.core.tools import Logger
from v1_0.core.constant import CV_SERVER,PICKER_SERVER,LOGGER_LEVEL
from v1_0.core.message_class import create_message
...
class CvMain:
    def __init__(self,send_queue,recv_queue):
        v1_0.servers.constant.SERVER_LOG = Logger(name="CV",level=LOGGER_LEVEL)

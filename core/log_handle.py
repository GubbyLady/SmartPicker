...
class MyLog:
    def __init__(self):
        ...
        self.my_log = LogManager("my_log").get_logger_and_add_handlers(log_level_int=10,log_path=self.log_path,log_filename="smart_picker_log.log")
        """
        ...
        """
        # self.my_log.debug("debug级别日志不会打印")
        # self.my_log.info("MyLog日志类--初始化成功")

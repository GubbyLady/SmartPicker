...
from servers.cv_server.constant import *
from core.message_class import Message
from servers.cv_server.constant import MODEL_PATH
from servers.picker_server.constant import CLASS_NUM_ONE, CLASS_NUM_TWO, CLASS_NUM_THREE
from fast_version.constant import FAST_LOG
...
class Fast_SmartPicker:
    def __init__(self):
        fast_version.constant.FAST_LOG= Logger(name="FAST_APP",level=LOGGER_LEVEL)
